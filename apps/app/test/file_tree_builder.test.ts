...
// Mock misc_global_states if needed (it is imported in builder.ts but not used in these functions explicitly,
// but might be needed for module load)
...
describe('file_tree/builder', () => {
  describe('transform_entries_to_filenode', () => {
    it('transforms directory entries to file nodes', async () => {
